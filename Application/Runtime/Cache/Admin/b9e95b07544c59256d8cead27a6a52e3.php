        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form method = 'post' action = '<?php echo U("Common/deleteAll",array("model"=>"liuyan"));?>'>
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        <td><input type="checkbox" class="i-checks" name = "xuanze[]" value="<?php echo ($vo["id"]); ?>"></td>
                        <td><?php echo ($vo["id"]); ?></td>
                        <td><?php echo ($vo["title"]); ?></td>
                        <td><?php echo (date( "Y-m-d H:i:s",$vo["ctime"])); ?></td>
                        <td>
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <a href="<?php echo U('Liuyan/delete',array('id'=>$vo['id']));?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
                    </tr><?php endforeach; endif; ?>
                    </tbody>
                    <?php echo ($page); ?>
                    </table>
                    <button class="btn btn-primary " type="button" id = "checkAll">全选</button>
                    <button class="btn btn-info " type="button" id = "noCheckAll">全不选</button>
                    <button class="btn btn-warning " type="button" id = "checkOrther">反选</button>
                    <button class="btn btn-success " type="submit" id = "deleteAll">删除</button>
                    </form>
                    </div>
                </div>
            </div>
