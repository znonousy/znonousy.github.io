    ...
    <div id="wrapper">
      ...
      <nav class="navbar-default navbar-static-side" role="navigation" id = "navs">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><a href="<?php echo U('Article/index');?>" ><button type="button" class="btn btn-w-m btn-success">返回文章列表</button></a></h2>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                            <?php if($vo["uid"] != 0): ?><a href="<?php echo U('Home/Blog/index',array('id'=>$vo['uid']));?>" target="_blank"><button type="button" class="btn btn-w-m btn-info">查看</button></a><?php endif; ?>
                        </td>
                        <td><?php echo (date( "Y-m-d H:i:s",$vo["ctime"])); ?></td>
                        <td><?php if($vo["status"] == 1): ?><span class="label label-danger">不显示</span><?php else: ?><span class="label label-info">显示</span><?php endif; ?></td>
                        <td>
                            <?php if($vo["istop"] == 1): ?><a href="<?php echo U('Article/changeCommentStatus',array('id'=>$vo['id'],'status'=>0));?>" ><button type="button" class="btn btn-w-m btn-success">显示</button></a>
                            <?php else: ?>
                            <a href="<?php echo U('Article/changeCommentStatus',array('id'=>$vo['id'],'status'=>1));?>" ><button type="button" class="btn btn-w-m btn-warning">不显示</button></a><?php endif; ?>
                            <a href="<?php echo U('Article/delComment',array('id'=>$vo['id']));?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
