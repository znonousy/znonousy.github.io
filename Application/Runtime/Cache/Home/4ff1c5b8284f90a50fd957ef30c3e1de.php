                    ...
                    <div class="carousel slide" id="carousel2" >
                        ...
                        <div class="carousel-inner"  >
                            ...
                            <div class="item" ><?php endif; ?>
                               <a href="<?php echo ($vo["url"]); ?>" target="_blank"><img alt="<?php echo ($vo["title"]); ?>" class="img-responsive" src="/MyBlog-master/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="width:100%;height: 550px;"></a>
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                <img alt="image" class="img-responsive" src="/MyBlog-master/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="max-height:150px;min-height:120px;">
