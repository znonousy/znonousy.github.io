...
<head>
    ...
    <title>我的留言-<?php echo ($SiteInfo["title"]); ?></title>
    <!-- load stylesheets -->
...
<!-- 正文开始 -->
<li class="selected" id = "liselected4">
        ...
        <div class="row">
                <div class="col-xs-12">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox diannao">
                        <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>的留言</a>
                                    </h5>
                                </div>
                                <?php if($k == 0): ?><div id="collapse<?php echo ($vo["id"]); ?>" class="panel-collapse collapse in">
                                        <?php else: ?>
                                        <div id="collapse<?php echo ($vo["id"]); ?>" class="panel-collapse collapse"><?php endif; ?>
                                        <div class="panel-body">
                                            姓名：<?php echo ($vo["name"]); ?>   <br>
                                            邮箱：<?php echo ($vo["email"]); ?>   <br>
                                            电话：<?php echo ($vo["tel"]); ?>   <br>
